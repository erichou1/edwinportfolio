<template>
  <div class="bizScene">
    <TitleSection scene="bizTitle">
      <TitleFunction params="2023,current">Los Gatos Hacks</TitleFunction>
    </TitleSection>
    ...
    <SceneSection id="biz2">
      <TextBlock>
        <p>
          Throughout the years I assisted 50+ students through
          <span class="-big -purple">
            office hours, discussion forums, and video lectures
          </span>
          with 10 qualifying for the American Invitational Mathematics Examination (AIME) invitational exam.
        </p>
      </TextBlock>
    </SceneSection>
